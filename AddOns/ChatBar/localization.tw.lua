...
CHATBAR_BN_WHISPER_ABRV			= "密";
CHATBAR_BN_CONVERSATION_ABRV		= "對";
...
CHATBAR_MENU_CHANNEL_BLOCK		= "封鎖 \"%s\" 頻道";
...
CHATBAR_BLOCKED				= "已封鎖 \"%s\" 頻道。"
CHATBAR_UNBLOCKED			= "已恢復 \"%s\" 頻道。"
...
CHATBAR_MENU_NONE 			= "無";
CHATBAR_MENU_BINDING 			= "設置綁定的名稱";
CHATBAR_MENU_BINDING_TITLE 		= "選擇更換綁定的頻道";
