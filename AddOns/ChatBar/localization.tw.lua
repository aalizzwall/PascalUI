...
CHATBAR_MENU_WHISPER_RETELL			= "重複(密語)";
CHATBAR_MENU_CHANNEL_STICKY			= "依附 頻道";
...
BINDING_NAME_CHATBAR_SAY		= "說頻道";
BINDING_NAME_CHATBAR_YELL		= "大喊頻道";
BINDING_NAME_CHATBAR_GUILD		= "公會頻道";
BINDING_NAME_CHATBAR_OFFICER	= "幹部頻道";
BINDING_NAME_CHATBAR_PARTY		= "隊伍頻道";
BINDING_NAME_CHATBAR_RAID		= "團隊頻道";
BINDING_NAME_CHATBAR_EMOTE		= "表情頻道";

BINDING_NAME_CHATBAR_CHANNEL_FORMAT = "聊天頻道 %s";

CHATBAR_MENU_NONE = "無";
CHATBAR_MENU_BINDING = "設定綁定的名稱"
CHATBAR_MENU_BINDING_TITLE = "選擇綁定的替換頻道"
