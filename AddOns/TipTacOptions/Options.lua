...
local options = {
	...
	{
		[0] = L["Special"],
		{ type = "Slider", var = "gttScale", label = L["GameTooltip Scale"], min = 0.2, max = 4, step = 0.05 },
		...
		{ type = "Check", var = "hideFactionText", label = L["Hide Faction Text"], tip = L["Strips the Alliance or Horde faction text from the tooltip"], y = 16 },
 	},
	-- Colors
	{
		[0] = L["Colors"],
		...
		{ type = "Check", var = "classColoredBorder", label = L["Color Tip Border by Class Color"], tip = L["For players, the border color will be colored to match the color of their class"], y = 12 },
	},
	-- Reactions
	{
		[0] = L["Reactions"],
	...
	-- Icon
	{
		...
		{ type = "Check", var = "iconCombat", label = L["Show Combat Icon"], tip = L["Shows a combat icon next to the tip, if the unit is in combat"], y = 12 },
...
if (TipTacItemRef) then
	options[#options + 1] = {
		...
		{ type = "Check", var = "if_showSpellIdAndRank", label = L["Show Spell ID & Rank"], tip = L["For spell tooltips, show their spellID and spellRank"] },
...
--		{ type = "Check", var = "if_showAchievementIdAndCategory", label = L["Show Achievement ID & Category"], tip = L["On achievement tooltips, the achievement ID as well as the category will be shown"] },
		...
		{ type = "Check", var = "if_showIcon", label = L["Show Icon Texture and Count (when available)"], tip = L["Shows an icon next to the tooltip"] },
