...
L["For players, the border color will be colored to match the color of their class"] = "對于玩家, 邊框顔色將被著色來匹配他們的職業";
-- Reactions		
L["Reactions"] = "反應";
...
L["For spell tooltips, show their spellID and spellRank"] = "對于法術提示訊息, 顯示它們的法術編號及法術等級";
...
L["Show Icon Texture and Count (when available)"] = "顯示圖標材質及計數 (當可用時)";
L["Shows an icon next to the tooltip"] = "提示訊息旁顯示圖標";
...
L["|r. Please make sure the addon is enabled from the character selection screen."] = "|r. 請確定插件已在角色選擇介面啓動.";
L["The following |2parameters|r are valid for this addon:"] = "以下 |2parameters|r 可用於此插件:";
...
L[" <DND>"] = " <請勿打擾>";
L["\n|cffffd100Targeting: "] = "\n|cffffd100目標: ";
L["Targeted By (|cffffffff%d|r): %s"] = "以此為目標 (|cffffffff%d|r): %s";
L["%.1fWan"] = "%.1f萬";
L["%.2fYi"] = "%.2f億";