...
L["For spell tooltips, show their spellID and spellRank"] = "对于法术提示信息, 显示它们的法术编号及法术等级";
...
L["Show Icon Texture and Count (when available)"] = "显示图标材质及计数 (当可用时)";
L["Shows an icon next to the tooltip"] = "提示信息旁显示图标";
