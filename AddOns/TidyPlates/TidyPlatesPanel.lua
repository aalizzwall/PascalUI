...
local NO_AUTOMATION = "關閉自動顯示"
local DURING_COMBAT = "戰鬥中顯示, 戰鬥結束後隱藏"
local OUT_OF_COMBAT = "戰鬥開始時隱藏, 戰鬥結束時顯示"
...
--]]
	...
	panel.PrimaryLabel:SetText("主天賦風格:")
	...
	panel.SecondaryLabel:SetText("副天賦風格:")
	...
	panel.AutoShowEnemyLabel:SetText("敵方姓名板:")
	...
	panel.AutoShowFriendlyLabel:SetText("友好姓名板:")
...
--]]
	...
	--[[
	-- Cast Watcher
	panel.EnableCastWatcher = PanelHelpers:CreateCheckButton("TidyPlatesOptions_EnableCastWatcher", panel, "顯示非目標施法條 (如果可用)")
...
--]]
	...
	-- Soft Transitions
	panel.DisableSoftTransitions = PanelHelpers:CreateCheckButton("TidyPlatesOptions_DisableSoftTransitions", panel, "關閉轉場效果")
	...
	-- CompatibilityMode
	panel.CompatibilityMode = PanelHelpers:CreateCheckButton("TidyPlatesOptions_CompatibilityMode", panel, "相容性模式（需要UI界面重載）")
	...
	-- Minimap Button
	--[[
	panel.EnableMinimapButton = PanelHelpers:CreateCheckButton("TidyPlatesOptions_EnableMinimapButton", panel, "啟用小地圖按鈕")
	...
	ResetButton:SetScript("OnClick", function()
		...
		if IsShiftKeyDown() then
			...
			-- InterfaceOptionsFrame_OpenToCategory(_G["InterfaceOptionsNamesPanel"])
			print(yellow.."重置 "..orange.."Tidy Plates"..yellow.." 回復為預設值")
			print(yellow.."按住 "..blue.."Shift 鍵"..yellow.." 同時點擊 "..red.."回復"..yellow.." 將清除您保存的設置，並重新載入用戶介面.")
		end
