...
L["Apexis Crystals (Total)"] = "頂尖水晶(總計)"
...
L["Buildings: Total"] = "建築：總計"
L["Can be activated"] = "可以啟用"
L["Character next mission"] = "角色下個任務"
L["Character next shipment"] = "角色下個訂單"
L["Character/Realm next mission"] = "角色/伺服器下個任務"
L["Character/Realm next shipment"] = "角色/伺服器下一個訂單"
L["Collapse all other characters on login"] = "登入時摺疊收起其他所有角色的資訊"
L["Compact Toast"] = "簡潔的彈出視窗"
L["Compact Tooltip"] = "簡潔的工具提示"
L["Complete!"] = "完成！"
...
L["Current Player Shipments: Total"] = "目前玩家訂單：總計"
L["Custom"] = "自訂"
...
L["Don't display characters without missions"] = "不要顯示沒有任務的角色"
L["Don't play pulse/flash animations on Minimap-Button"] = "不播放脈衝/閃光動作特效在小地圖按鈕上"
L["Don't show empty newlines in tooltip"] = "不在工具提示顯示空的新行"
...
L["Garrison Resources (Total)"] = "要塞資源(總計)"
L["Garrison Resources (Total, Formatted)"] = "要塞資源(總計、格式)"
...
L["In Progress: %s | Complete: %s | Total: %s"] = "進行中: %s | 完成: %s"
...
L["Shipments Ready + Time/Char to next shipment (All characters)"] = "訂單準備 + 下次訂單時間/角色 (所有角色)"
L["Shipments Ready + Time to next shipment (All characters)"] = "訂單準備 + 下次訂單時間 (所有角色)"
L["Shipments: Total"] = "訂單：總計"
L["Shipments Total (Progress+Ready)"] = "訂單總計 (進行中+已準備)"
L["Show Icons"] = "顯示圖標"
L["Show followers for each mission"] = "顯示每個任務的追隨者"
L["Show only current realm"] = "只顯示當前的伺服器"
...
L["Time until next shipment"] = "直到下次訂單時間"
L["Toast Notifications"] = "彈出視窗通知"
L["Tooltip"] = "工具提示"
L["Tooltip Scale"] = "工具提示大小"
L["Total: %s"] = "總計：%s"
L["Total: %s | In Progress: %s | Complete: %s"] = "總計：%s | 進行中：%s | 完成：%s"
