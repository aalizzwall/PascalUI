...
L:AddLocale("zhCN",  
{
	...
	["Click the edit box to open it up for editing. Only available if Autohide is disabled."] = "点击编辑框以打开进行编辑. 仅自动隐藏关闭时可用.", -- Needs review
	DIALOG = "对话框", -- Needs review
	["Editbox options."] = "输入框选项", -- Needs review
	["Enable Arrowkeys"] = "允许方向键", -- Needs review
	["Enable using arrowkeys in editbox without the alt key."] = "在编辑框中开启不使用alt键的方向键.", -- Needs review
	["Hide Border"] = "隐藏边框", -- Needs review
	["Hide the border around the edit box."] = "隐藏编辑框周围的边框.", -- Needs review
	["Hide the edit box after you have pressed enter."] = "按回车键后隐藏编辑框.", -- Needs review
	HIGH = "高", -- Needs review
	["Lock editbox position if undocked."] = "非停靠时锁定编辑框位置.", -- Needs review
	["Lock Position"] = "锁定位置", -- Needs review
	LOW = "低", -- Needs review
	MEDIUM = "中", -- Needs review
	OriginalEditbox = "原始编辑框", -- Needs review
	Padding = "填白", -- Needs review
	["Set Alpha"] = "设置透明度", -- Needs review
	["Set Position"] = "设置位置", -- Needs review
	["Set Strata"] = "设置阶层", -- Needs review
	["Set the alpha of the editbox."] = "设置编辑框的透明度.", -- Needs review
	["Set the amount of padding inside the edit box"] = "设置编辑框的内填白值.", -- Needs review
	["Set the edit box background colour"] = "设置编辑框的背景颜色.", -- Needs review
	["Set the edit box border colour"] = "设置编辑框边框的颜色.", -- Needs review
	["Set the frame strata of the editbox."] = "设置编辑框的框架阶层.", -- Needs review
	["Set the position of the editbox."] = "设置编辑框的位置.", -- Needs review
	["Set the texture of the chat edit box"] = "设置聊天编辑框的材质.", -- Needs review
	["Set the width of the editbox."] = "设置编辑框的宽度.", -- Needs review
	["Set the width of the edit box's border"] = "设置编辑框边框的宽度.", -- Needs review
	["Set Width (NB: only enabled if the editbox is undocked)"] = "设置宽度 (仅编辑框未停靠时开启)", -- Needs review
	Texture = "材质", -- Needs review
	Top = "顶部", -- Needs review
	Undocked = "非停靠", -- Needs review
}

)
L:AddLocale("esES",  
{
	Autohide = "Auto Ocultar", -- Needs review
	BACKGROUND = "FONDO", -- Needs review
	["Bar colour"] = "Color de la barra", -- Needs review
	-- ["Border colour"] = "",
	-- ["Border width"] = "",
	-- Bottom = "",
	-- Clickable = "",
