...
TELLMEWHEN_VERSION = "7.2.4"

TELLMEWHEN_VERSION_MINOR = ""
local projectVersion = "7.2.4" -- comes out like "6.2.2-21-g4e91cee"
...
TELLMEWHEN_VERSIONNUMBER = 72415 -- NEVER DECREASE THIS NUMBER (duh?).  IT IS ALSO ONLY INTERNAL (for versioning of)
