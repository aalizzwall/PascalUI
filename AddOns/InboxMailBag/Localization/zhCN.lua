...
L["ADVANCED_MODE_DISABLED"] = "|cff00ff96InboxMailbag: 进阶模式|r 关闭"
L["ADVANCED_MODE_ENABLED"] = "|cff00ff96InboxMailbag: 进阶模式|r 启用"
L["BAGNAME"] = "邮包"
...
L["MAIL_DEFAULT_DESC"] = "启用此选项会导致信箱最初打开的是邮包，而非一般%s"
L["MAIL_DEFAULT_DISABLED"] = "|cff00ff96InboxMailbag: 信箱预设为|r %s"
L["MAIL_DEFAULT_ENABLED"] = "|cff00ff96InboxMailbag: 信箱预设为|r 信箱邮包"
L["QUALITY_COLOR_MODE_DESC"] = "启用可由物品的边框显示物品的品质"
L["Quality Colors"] = "品质着色"
L["QUALITY_COLORS_MODE_DISABLED"] = "|cff00ff96InboxMailbag: 品质着色|r 关闭"
L["QUALITY_COLORS_MODE_ENABLED"] = "|cff00ff96InboxMailbag: 品质着色|r 启用"
