...
L["ADVANCED_MODE_DISABLED"] = "|cff00ff96InboxMailbag: 進階模式|r 關閉"
L["ADVANCED_MODE_ENABLED"] = "|cff00ff96InboxMailbag: 進階模式|r 啟用"
L["BAGNAME"] = "郵包"
...
L["MAIL_DEFAULT_DESC"] = "啟用此選項會導致信箱最初打開的是郵包，而非一般%s"
L["MAIL_DEFAULT_DISABLED"] = "|cff00ff96InboxMailbag: 信箱預設為|r %s"
L["MAIL_DEFAULT_ENABLED"] = "|cff00ff96InboxMailbag: 信箱預設為|r 信箱郵包"
L["QUALITY_COLOR_MODE_DESC"] = "啟用可由物品的邊框顯示物品的品質"
L["Quality Colors"] = "品質著色"
L["QUALITY_COLORS_MODE_DISABLED"] = "|cff00ff96InboxMailbag: 品質著色|r 關閉"
L["QUALITY_COLORS_MODE_ENABLED"] = "|cff00ff96InboxMailbag: 品質著色|r 啟用"
