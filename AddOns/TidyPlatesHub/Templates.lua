...
local function CreateInterfacePanel( objectName, panelTitle, parentTitle)
	...
	CopyThemeDataButton.tooltipText = "複製你的設置到剪切板，按住'shift'點擊使用特有的剪切板"
	...
	CopyThemeDataButton:SetText("複製")
	...
	ReloadThemeDataButton.tooltipText = "重置你的配置為默認.  按住'shfit'點擊將會清除所有已存儲的設置，並重載界面."
