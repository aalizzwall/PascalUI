...
function InlineAura_LoadDefaults()
  ...
  -- to prevent my checking script from whinning
	...
	------------------------------------------------------------------------------
		...
		SelfTalentProc( 20243):Glowing() -- Devestate => Incite
		...
		Spells(1680, 96103):Aliases(12950):OnSelf():WithStack()
	...
	------------------------------------------------------------------------------
		...
		Spells(73680):Aliases(73683, 73681):OnSelf()
	end
...
--		)
	...
	------------------------------------------------------------------------------
		...
		Aliases(102560, 102543, 102558, 33891):OnSelf():OnlyMine()
	...
	------------------------------------------------------------------------------
		...
		SelfTalentProc(86659) -- Guardian of Ancient Kings
