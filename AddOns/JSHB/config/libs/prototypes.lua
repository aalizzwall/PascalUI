...
local DataVersion = 1
local AGSMW = LibStub:NewLibrary("AceGUISharedMediaWidgets-1.0-JS", DataVersion)
...
AceGUIWidgetLSMlists = {
	...
	['font'] = JSHB.MakeLSMHashTable(JSHB.defaultFonts, "font"),
	['sound'] = JSHB.MakeLSMHashTable(JSHB.defaultSounds, "sound"),
	['statusbar'] = JSHB.MakeLSMHashTable(JSHB.defaultTextures, "statusbar"),
	['border'] = JSHB.MakeLSMHashTable(JSHB.defaultBorders, "border"),
	['background'] = JSHB.MakeLSMHashTable(JSHB.defaultBackgrounds, "background"),
}
