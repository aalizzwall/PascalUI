...
L["COLORCHRONOS"] = "Хронометры" -- Needs review
L["COLORCHRONOS_DESC"] = "Установить цвет хронометров" -- Needs review
...
L["HIDESHOW_BUTTONS"] = "Скрыть/Показать кнопки" -- Needs review
...
L["IS_HERE_MSG"] = "Decursive инициализирован, не забудьте проверить настройки" -- Needs review
...
L["OPT_ALLOWMACROEDIT"] = "Разрешить редактирование макроса" -- Needs review
...
L["OPT_LIVELIST_DESC"] = "Настройки активного списка" -- Needs review
...
L["OPT_MACROOPTIONS_DESC"] = "Установка поведения макросов, созданных Decursive" -- Needs review
...
L["OPT_NOSTARTMESSAGES_DESC"] = "Отключает выводимые сообщения Decursivа в окно чата при каждом подключении." -- Needs review
