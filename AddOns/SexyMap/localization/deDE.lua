...
L["2. Border"] = "2. Rahmen"
L["3. Artwork"] = "Vorlagen"
L["4. Overlay"] = "Überlagerung"
...
L["Always"] = "Immer"
L["Are you sure you want to switch back to using a character specific profile? This will reload your UI."] = "Bist du dir sicher, dass du zurück auf das Charakter spezifische Profil wechseln willst? Dies wird dein Interface neu laden."
...
L["Let SexyMap handle button dragging"] = "Ermögliche SexyMap die Kontrolle über die Positionierung der Minimap-Knöpfe"
L["Lock Button Dragging"] = "Ziehen der Knöpfe verhindern"
L["Lock Coordinates"] = "Koordinaten sperren"
L["Lock Minimap"] = "Minimap sperren"
...
L["Movers Warning"] = "WARNUNG: Diese Funktion wird nicht offiziell unterstützt. Es kann zu Problemen, wie z.B. Flecken, Verlust der Quest-Verfolgung oder 'springenden' Boss-Anzeigen, führen. Blizzard Frames wie der QuestTracker und die Boss-Anzeige sind nicht für Umpositionierungen ausgelegt. Es wird empfohlen, diese durch AddOns zu ersetzen; z.B. durch UnitFrames mit Boss-Anzeige."
L["Name"] = "Name"
L["Never"] = "Niemals"
...
L["Quickly change the look of your minimap by using a minimap preset."] = "Das Aussehen der Minimap schnell ändern, indem eine Voreinstellung geladen wird"
...
L["Spice up your minimap with some sexy options."] = "Peppe deine MiniMap auf, mit ein paar sexy Optionen."
L["Square"] = "Rechteck"
...
L["Turn this off if you want another mod to handle which buttons are visible on the minimap."] = "Deaktiviere diese Option, wenn du ein anderes Addon für die Sichtbarkeit der Minimap-Knöpfe benutzt."
...
L["Video Recording Button (Mac OSX Only, When Available)"] = "Videoaufname-Knopf (Nur Mac OSX, falls verfügbar)"
L["Visibility"] = "Sichtbarkeit"
L["Voice Chat Button (When Available)"] = "Voice Chat Knopf (wenn verfügbar)"
L["Width"] = "Breite"
L["You can set a background and edge file for the minimap like you would with any frame. This is useful when you want to create static square backdrops for your minimap."] = "Du kannst einen Hintergrund und Rahmen für die Minimap einstellen, genauso wie bei allen anderen Rahmen. Dies ist nützlich, wenn du einen statischen rechteckigen Hintergrund für die Minimap erstellen möchtest."
